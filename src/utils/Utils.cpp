...
#include <corgi/utils/stb_image.h>
//#include "stb_image_write.h"

corgi::Image* Editor::Utils::LoadImageForReal(const std::string& imageFile)
{
    int x, y, channels;
    // Images are horizontal on OpenGL otherwise
    stbi_set_flip_vertically_on_load(true);

    stbi_uc* imageData = stbi_load(imageFile.c_str(), &x, &y, &channels, STBI_rgb_alpha);
