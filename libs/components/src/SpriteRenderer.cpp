...
namespace corgi
{
    SpriteRenderer::SpriteRenderer()
        : _material(*ResourcesCache::get<Material>("corgi/materials/unlit/unlit_sprite.mat"))
    {
    }
    ...
    void SpriteRenderer::flip_horizontal() { _flipped_x = !_flipped_x; }
    ...
    const Material& SpriteRenderer::material() const { return _material; }
    ...
    Sprite& SpriteRenderer::sprite() { return sprite_; }

    Vec2 SpriteRenderer::pivot() const noexcept { return _pivot_value; }

    bool SpriteRenderer::is_horizontally_flipped() const noexcept { return _flipped_x; }

    bool SpriteRenderer::is_vertically_flipped() const noexcept { return _flipped_y; }
}    // namespace corgi
