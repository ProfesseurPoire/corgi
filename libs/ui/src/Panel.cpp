...
namespace corgi::ui
{
    void Panel::paint(Renderer& renderer)
    {
        ...
        //try
        //{
        ns.material = *ResourcesCache::get<Material>("corgi/materials/unlit/unlit_texture.mat");
        if(ns.material._texture_uniforms.empty())
            ns.material.add_texture(*ResourcesCache::get<Texture>("corgi/textures/mp.tex"));
        else
            ns.material.set_texture(0, *ResourcesCache::get<Texture>("corgi/textures/mp.tex"));
        //}
