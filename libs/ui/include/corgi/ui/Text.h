...
namespace corgi::ui
{
    ...
    public:
         ...
         */
        [[nodiscard]] const SimpleString& text() const;
         ...
         */
        [[deprecated("Use setText instead")]] void text(const SimpleString& str);
         ...
         * @return SimpleString 
         */
        void setShortenedLineString(const SimpleString& text);
         ...
         * @return float 
         */
        [[nodiscard]] float textWidth(const SimpleString& text) const;
        ...
        [[nodiscard]] const corgi::Vector<corgi::utils::text::ShapedGlyph>&
