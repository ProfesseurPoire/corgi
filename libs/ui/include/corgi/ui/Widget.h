...
public:
    ...
    /**
         ...
         * @param w 
         */
    virtual void handleNewChild(Widget* w) { std::cout << w->name() << std::endl; };
    ...
    [[nodiscard]] Event<const Mouse&>& mouse_drag_event() { return mouse_drag_event_; }

    [[nodiscard]] Event<const Mouse&>& mouse_drag_start_event()
    {
        return mouse_drag_start_event_;
    }

    [[nodiscard]] Event<const Mouse&>& mouse_drag_end_event()
    {
        return mouse_drag_end_event_;
    }

    [[nodiscard]] Event<const Mouse&>& on_mouse_over() { return on_mouse_over_; }
    ...
    /**
         ...
         * @return Widget* 
         */
    Widget* find(const std::string& name) const noexcept;
    ...
    void setParentHeightCache(float parentHeight) { parentHeightCache_ = parentHeight; }
...
protected:
    ...
    Event<const Mouse&> on_mouse_over_;
    ...
    Event<const Mouse&> mouse_drag_event_;
    Event<const Mouse&> mouse_drag_start_event_;
    Event<const Mouse&> mouse_drag_end_event_;
