...
namespace corgi::math
{
	...
	// Used by the sat
	Vec3 project_points(const Vec3* points, int points_size, const Vec3& axis);
	Vec2 project_points(const Vec2* points, int points_size, const Matrix& mat, const Vec2& axis);
