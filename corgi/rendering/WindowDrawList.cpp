                                   ...
                                   const float a)
{
    ...
    rectangle.material = *ResourcesCache::get<Material>("corgi/materials/unlit/unlit_color.mat");
...
void WindowDrawList::add_rectangle(
    const float x, const float y, const float width, const float height, const Texture& texture)
{
    DrawList::Rectangle rectangle;

    rectangle.material = *ResourcesCache::get<Material>("corgi/materials/unlit/unlit_texture.mat");
...
void WindowDrawList::add_sprite(float x, float y, const Sprite sprite)
{
    ...
    dwsprite.material = *ResourcesCache::get<Material>("corgi/materials/unlit/unlit_texture.mat");
...
void WindowDrawList::add_sprite(float x, float y, float width, float height, const Sprite sprite)
{
    DrawList::DrawListSprite dwsprite;
    dwsprite.sprite = sprite;
...
{
    text.position.y = static_cast<float>(window_.height()) - text.position.y - text.dimensions.y;
    draw_list_.add(text);
}

void WindowDrawList::add_mesh(const Mesh& mesh, const Matrix& model_matrix, const Material& material)
{
    draw_list_.add_mesh(mesh, model_matrix, material);
}