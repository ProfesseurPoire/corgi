 ...
 */
    ...
    public:
        ...
        Material(const SimpleString& name = "empty");
        Material(const SimpleString& path, const SimpleString& relative_name);
        ...
        void set_texture(int index, const Texture& texture, const SimpleString& name);
        ...
        struct TextureUniform
        {
            ...
            TextureUniform(const SimpleString& n, int p_location, const Texture* t)
            {
        ...
        void set_uniform(const SimpleString& name, int value);
        void set_uniform(const char* name, int value);

        void set_uniform(const char* name, unsigned value);

        void set_uniform(int index, const SimpleString& name, int value);

        void set_uniform(const SimpleString& name, float value);
        void set_uniform(const char* name, float value);

        void set_uniform(int index, const SimpleString& name, float value);

        void set_uniform(const SimpleString& name, Vec2 value);
        void set_uniform(const SimpleString& name, float x, float y);
        void set_uniform(int index, const SimpleString& name, float x, float y);

        void set_uniform(const SimpleString& name, Vec3 value);
        void set_uniform(const SimpleString& name, float x, float y, float z);

        void set_uniform(const SimpleString& name, const Color& color);
        void set_uniform(const char* name, const Color& color);

        void set_uniform(const SimpleString& name, Vec4 value);
        void set_uniform(const SimpleString& name, float x, float y, float z, float w);
        void set_uniform(const char* name, Vec4 value);
        void set_uniform(const char* name, float x, float y, float z, float w);
        void set_uniform(
            int index, const SimpleString& name, float x, float y, float z, float w);
        ...
        struct Uniform
        {
            ...
            explicit Uniform(const SimpleString& p_name, int p_location, int v)
            ...
            explicit Uniform(const SimpleString& p_name, int p_location, float v)
            ...
            explicit Uniform(const SimpleString& p_name, int p_location, Vec2 v)
            ...
            explicit Uniform(const SimpleString& p_name, int p_location, Vec3 v)
            ...
            explicit Uniform(const SimpleString& p_name, int p_location, Vec4 v)
                : data(v)
            {
                std::strcpy(name, p_name.c_str());
                location = p_location;
	 ...
	 */
        ...
        Vector<TextureUniform> _texture_uniforms;
